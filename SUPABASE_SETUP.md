...
This document contains all the SQL commands and configuration needed to set up your E-Classroom LMS database in Supabase.
...
Go to your Supabase project dashboard → SQL Editor → New Query, then copy and paste the following SQL:
...
Go to Database → Replication in your Supabase dashboard and enable realtime for the `notifications` table.

## Step 5: Create First Admin User

After setting up authentication in your app, you'll need to manually set the first user's role to 'admin' in the users table.

## Verification

To verify your setup:

1. Check that all tables are created in Database → Tables
2. Check that RLS is enabled on all tables
3. Check that storage buckets are created in Storage
4. Check that storage policies are applied

## Next Steps

Your database is now ready! Return to the main application to continue development.
